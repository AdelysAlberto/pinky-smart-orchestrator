...
| Trigger                       | Skill                                          |
| ----------------------------- | ---------------------------------------------- |
| Visual design / UI craft      | `~/.cursor/skills/visual-craft/SKILL.md`     |
| Mobile UX                     | `~/.cursor/skills/mobile-native/SKILL.md`    |
| CSS/presentation architecture | `~/.cursor/skills/css-architecture/SKILL.md` |
