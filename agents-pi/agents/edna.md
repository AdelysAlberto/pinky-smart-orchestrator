...
| Trigger                       | Skill                                          |
| ----------------------------- | ---------------------------------------------- |
| Visual design / UI craft      | `~/.pi/agent/skills/visual-craft/SKILL.md`     |
| Mobile UX                     | `~/.pi/agent/skills/mobile-native/SKILL.md`    |
| CSS/presentation architecture | `~/.pi/agent/skills/css-architecture/SKILL.md` |
