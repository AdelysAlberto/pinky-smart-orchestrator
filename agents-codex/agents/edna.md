...
| Trigger                       | Skill                                          |
| ----------------------------- | ---------------------------------------------- |
| Visual design / UI craft      | `~/.codex/skills/visual-craft/SKILL.md`     |
| Mobile UX                     | `~/.codex/skills/mobile-native/SKILL.md`    |
| CSS/presentation architecture | `~/.codex/skills/css-architecture/SKILL.md` |
