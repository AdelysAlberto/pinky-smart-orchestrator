...
| Trigger                       | Skill                                          |
| ----------------------------- | ---------------------------------------------- |
| Visual design / UI craft      | `~/.claude/skills/visual-craft/SKILL.md`     |
| Mobile UX                     | `~/.claude/skills/mobile-native/SKILL.md`    |
| CSS/presentation architecture | `~/.claude/skills/css-architecture/SKILL.md` |
